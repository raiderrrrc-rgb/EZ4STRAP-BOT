...
async def ayuda(ctx):
    ...
    embed.add_field(name="!addkey <nota>", value="Crea una key nueva", inline=False)
    ...
    embed.add_field(name="!banear <discord_name> [razon]", value="Banear manualmente", inline=False)
